...
class TemucoPage extends StatefulWidget {
  @override
  _TemucoPageState createState() => _TemucoPageState();
}

class _TemucoPageState extends State<TemucoPage> {
  ...
  Future<void> initPlatformState() async {
    ...
    platformVersion = await FlutterGeocode.latlng(
        latitud = -38.73834350741858, longitud = -72.58760454594783);
